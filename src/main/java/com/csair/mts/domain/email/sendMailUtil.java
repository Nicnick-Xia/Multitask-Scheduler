...
public class sendMailUtil {
	...
	public class SendmailUtil {
	    ...
	    private static final String VALUE_SMTP = "smtp.126.com";
	    // 服务器验证
	    private static final String KEY_PROPS = "mail.smtp.auth";
	    // 发件人用户名、密码
	    private String SEND_USER = "csairgogogo@126.com";
	    private String SEND_UNAME = "csairgogogo@126.com";
	    private String SEND_PWD = "csaie2016";
	    // 建立会话
